...
| Tests | **249/249 passing**, 13 files (up from 30/8) — dependency-requiring tests SKIP on the base install rather than erroring |
...
22. ~~**[M] Auto-label Folder**~~ — **done (2026-07-15, Phase 4)**: `AssistController.score_folder`
    ...
    same action again (`libs/assist/controller.py:765-827`).
23. ~~**[S/M] Active learning (uncertainty-sorted review queue)**~~ — **done (2026-07-15,
    ...
    reordered stream (`libs/assist/controller.py:948-971`); `Restore Filesystem Order`
    undoes it. File-list rows show a live rank/score suffix and heat-map tint
    (`refresh_file_list`, `:1115-1162`).
